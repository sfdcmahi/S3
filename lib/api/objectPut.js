...
function objectPut(authInfo, request, streamingV4Params, log, callback) {
    ...
    (err, bucket, objMD) => {
        ...
        return async.waterfall([
            ...
            // objMD here is the master or null version that we would
            // have overwritten if there was an existing object or version
            if (!objMD || !objMD['content-length'] || isVersionedObj) {
                oldByteLength = null;
            } else {
